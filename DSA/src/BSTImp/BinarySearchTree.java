...
//    }
    ...
    public ArrayList<Integer> DFSInOrder(Node currentNode ){
    ...
    public void DFSStartInOrder(){
        System.out.println(DFSInOrder(root));
    }

    public ArrayList<Integer> DFSPreOrder(Node currentNode ){
    ...
    public void DFSStartPreOrder(){
        System.out.println(DFSPreOrder(root));
    }
